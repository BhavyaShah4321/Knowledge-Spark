...
//           // Extract teacher and student usernames from the first message
//           const firstMessage = response.data.data[0];
//           if (firstMessage) {
//             setTeacherUsername(firstMessage.user_1_username);
//             setStudentUsername(firstMessage.user_2_username);
//           }
//         } else {
...
//       ) : messages.length > 0 ? (
//         messages.map((msg) => {
//           const isTeacher = msg.sender_username === teacherUsername;
//           return (
//             <div
//               key={msg.id}
//               className={`message ${isTeacher ? "teacher-message" : "student-message"}`}
//             >
