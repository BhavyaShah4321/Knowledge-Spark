...
import {User3,User5,User2,User12, User1,User6, User11, User4, User13,User,play01,chatImg,voice,heart,like } from "../../imagepath"
                      ...
                      <div className="slimscroll">
                        ...
                        <div className="left-chat-title all-chats d-flex justify-content-between align-items-center">
                          <div className="select-group-chat">
                            <div className="dropdown">
                              <Link to="javascript:void(0);">All Chats</Link>
                            </div>
                          </div>
                            ...
                            <ul>
                              <li>
                                <Link
                                  ...
                                  className="user-chat-search-btn" onClick={() => setVisible(!visible)}
                                >
                        ...
                        <div className="top-online-contacts">
                          <div className="fav-title">
                            <h6>Online Now</h6>
                            <Link to="javascript:void(0);" className="view-all-chat-profiles">
                              View All
                            </Link>
                          </div>
                                ...
                                <div className="chat-content">
                                  ...
                                  <div className="message-content">
                                    <div className="location-sharing">
                                      ...
                                      <h6>
                                        My Location{" "}
                                        <Link to="javascript:void(0);">Download</Link>
                                      </h6>
                                    </div>
                                  </div>
